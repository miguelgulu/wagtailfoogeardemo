...
AUTH_LDAP_SERVER_URI = "ldap://192.168.122.14:389"

AUTH_LDAP_BIND_DN = "cn=admin,dc=wagtail,dc=local"
AUTH_LDAP_BIND_PASSWORD = "123456"
AUTH_LDAP_USER_SEARCH = LDAPSearch(
    "dc=wagtail,dc=local", ldap.SCOPE_SUBTREE, "(uid=%(user)s)"
)
...
AUTH_LDAP_USER_FLAGS_BY_GROUP = {
    "is_active": ["cn=staff,ou=groups,dc=wagtail,dc=local"],
    "is_staff": ["cn=staff,ou=groups,dc=wagtail,dc=local"],
    "is_superuser": ["cn=staff,ou=groups,dc=wagtail,dc=local"],
}
